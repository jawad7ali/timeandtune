<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('phone')" max-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.title }}</span>
          <el-tag>{{ row.type | typeFilter }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column :label="$t('Carrier Type')" width="110px" align="center">
        <template slot-scope="scope">
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle } from '@/api/carrier';
